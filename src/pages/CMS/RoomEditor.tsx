...
import { 
  GripVertical, Plus, X, FileImage, 
  FileVideo, Save, Clock, BookOpen, FileCheck
} from "lucide-react";
...
const RoomEditor = () => {
  ...
  const [room, setRoom] = useState(isNewRoom ? {
    id: "",
    title: "",
    subject: "Biology",
    level: "Beginner",
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div>
            ...
            <p className="text-muted-foreground">
              {isNewRoom ? "Create a new learning room for your students" : "Edit room content, sections, and quiz questions"}
            </p>
          </div>
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input 
                      id="module" 
                      value={room.module}
                      onChange={(e) => setRoom({ ...room, module: e.target.value })}
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="space-y-2">
                    ...
                    <Select 
                      value={room.subject} 
                      onValueChange={(value) => setRoom({ ...room, subject: value })}
                    >
                      <SelectTrigger>
                  ...
                  <div className="space-y-2">
                    ...
                    <Select 
                      value={room.level} 
                      onValueChange={(value) => setRoom({ ...room, level: value })}
                    >
                      <SelectTrigger>
                  ...
                  <div className="space-y-2">
                    ...
                    <Select 
                      value={room.duration} 
                      onValueChange={(value) => setRoom({ ...room, duration: value })}
                    >
                      <SelectTrigger>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <Input 
                      ...
                      onChange={(e) => setRoom({ ...room, instructor: e.target.value })}
                  ...
                  <div className="space-y-2">
                    ...
                    <Input 
                      ...
                      type="number"
                      value={room.xpPoints}
                      onChange={(e) => setRoom({ ...room, xpPoints: parseInt(e.target.value) || 0 })}
                  ...
                  <Droppable droppableId="questions">
                    {(provided) => (
                      ...
                      >
                        ...
                        {room.quiz.length === 0 && (
                          <div className="text-center p-8 border rounded-lg bg-muted/20">
                            <p className="text-muted-foreground">No questions yet. Click "Add Question" to create your first quiz question.</p>
                          </div>
                        )}
                      </div>
                    )}
