...
const challengeExams = [
  {
    ...
    subject: "Biology",
    description: "Test your knowledge with this comprehensive GCSE Biology mock exam covering key topics.",
    duration: "45 minutes",
    questions: 20,
  ...
  },
  {
    ...
    subject: "Chemistry",
    description: "Challenge yourself with advanced A-Level Chemistry questions focused on organic chemistry.",
    duration: "60 minutes",
    questions: 25,
    difficulty: "A-Level",
  ...
  },
  {
    ...
    subject: "Physics",
    description: "Test your understanding of forces, motion, and Newton's laws in this timed exam.",
    duration: "40 minutes",
    questions: 20,
    difficulty: "GCSE Level",
  ...
  },
  {
    ...
    subject: "Mathematics",
    description: "Challenge your algebraic skills with this A-Level Mathematics exam.",
    duration: "55 minutes",
    questions: 15,
    difficulty: "A-Level",
...
const Challenges = () => {
  ...
  const filteredChallenges = selectedSubject === "all" 
    ? challengeExams 
    : challengeExams.filter(challenge => challenge.subject.toLowerCase() === selectedSubject);
    ...
    <DashboardLayout>
      <div className="container px-4 py-6 max-w-6xl">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
          <div>
            <h1 className="text-3xl font-bold tracking-tight">Exam Challenges</h1>
        ...
        <Tabs defaultValue="challenges" className="mb-8">
            ...
            <div className="mb-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {filteredChallenges.map((challenge) => (
                  <Card key={challenge.id} className="overflow-hidden border border-gray-200 transition-all hover:shadow-md">
              ...
              {filteredChallenges.length === 0 && (
                <div className="text-center p-10 border rounded-lg">
                  <p className="text-muted-foreground">No challenges available for this subject yet.</p>
                </div>
              )}
            </div>
          </TabsContent>
          ...
          <TabsContent value="past">
            <div className="space-y-6">
              <h2 className="text-lg font-medium">Recently Completed Challenges</h2>
              
              {pastChallenges.map((challenge) => (
                <div key={challenge.id} className="border rounded-lg p-4 flex flex-col md:flex-row md:items-center justify-between gap-4">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-muted-foreground">{challenge.subject}</div>
                      <div className="text-sm text-muted-foreground">{challenge.date} • {challenge.timeSpent}</div>
                    </div>
                  </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                ...
                <Card className="border border-gray-200">
                  ...
                  <CardContent className="text-center pt-0">
                    ...
                    <p className="text-sm text-muted-foreground">Complete a challenge in record time</p>
                  </CardContent>
                  <CardFooter className="justify-center pt-0">
