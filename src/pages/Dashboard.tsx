...
const lessons = [
  {
    ...
    description:
      "Learn about the fundamental building blocks of all living organisms.",
    progress: 75,
    xp: 120,
    duration: "25 min",
    level: "Beginner",
  ...
  },
  {
    ...
    title: "Ecosystems",
    description:
      "Discover how organisms interact with each other and their environment.",
    progress: 0,
    xp: 150,
    duration: "40 min",
    level: "Beginner",
              ...
              {challenges.map((challenge) => (
                <Link to={`/exam-challenge/${challenge.id}`} key={challenge.id}>
                  <Card className="h-full transition-all hover:shadow-md hover:-translate-y-1 border-science-secondary/30">
                    ...
                    <CardContent>
                      <p className="text-sm text-muted-foreground mb-4">
                        Test your knowledge with this {challenge.difficulty}{" "}
                        exam challenge.
                      </p>
                    </CardContent>
                    <CardFooter className="flex justify-between pt-0">
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <p className="mt-2 text-xs text-muted-foreground">
                        {userStats.nextLevelXp - userStats.xp} XP needed to
                        reach Level {userStats.level + 1}
                      </p>
                    </div>
                    ...
                    <div className="mt-6">
                      ...
                      <div className="space-y-2">
                        {userStats.recentAchievements.map(
                          (achievement, index) => (
                            <div
                              key={index}
