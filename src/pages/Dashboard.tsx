          ...
          <Card className="bg-white border border-orange-100">
            <CardContent className="p-6">
              <div className="flex justify-between">
                ...
                <div className="bg-orange-50 rounded-full h-12 w-12 flex items-center justify-center">
            ...
            <CardContent className="p-6">
              <div className="flex justify-between">
                <div>
                  ...
                  <h2 className="text-2xl font-bold">Science Explorer</h2>
                  <p className="text-xs text-gray-500">
                    250 points to Science Enthusiast
                  </p>
                </div>
                <div className="bg-purple-50 rounded-full h-12 w-12 flex items-center justify-center">
          ...
          <div className="lg:col-span-2 space-y-8">
                      ...
                      <div className="flex items-start gap-4">
                        ...
                        <div>
                          ...
                          <div className="text-sm text-gray-500">
                            Module • Last accessed: 2 hours ago
                          </div>
                        </div>
                      </div>
                      <Button variant="outline" size="sm">
                    ...
                    <div className="flex justify-between mb-2">
                      <div className="flex items-start gap-4">
                        ...
                        <div>
                          ...
                          <div className="text-sm text-gray-500">
                            Learning Path • Last accessed: 1 day ago
                          </div>
                        </div>
                      </div>
                      <Button variant="outline" size="sm">
                    ...
                    <div className="flex justify-between mb-2">
                      <div className="flex items-start gap-4">
                        ...
                        <div>
                          ...
                          <div className="text-sm text-gray-500">
                            Module • Last accessed: 3 days ago
                          </div>
                        </div>
                      </div>
                      <Button variant="outline" size="sm">
            ...
            <Card className="bg-white">
              <CardHeader className="pb-2">
                ...
                <CardDescription>
                  Your learning journey highlights
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
